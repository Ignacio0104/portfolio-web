...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center px-8 overflow-hidden max-sm:px-5">
      {/* Radial glow */}
      <div
      ...
      <div className="max-w-[1200px] mx-auto w-full grid grid-cols-2 max-[900px]:grid-cols-1 items-center gap-16 max-[900px]:gap-12 pt-[68px] max-[900px]:text-center">
        {/* Left — text content */}

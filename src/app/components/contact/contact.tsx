...
const WHATSAPP_LINK = "https://wa.me/5491151476452";
              ...
              <div className="flex flex-col items-center gap-6 py-12 px-8 rounded-2xl border border-[rgba(79,142,247,0.2)] bg-[rgba(79,142,247,0.05)] text-center">
                ...
                <div>
                  <h3 className="text-base font-semibold text-[var(--text-primary)] mb-1">
                    {translate("contact", "successTitle")}
                  </h3>
                  <p className="text-sm text-[var(--text-secondary)]">
                    {translate("contact", "successDesc")}
                  </p>
                </div>
                <button
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  {touched.subject && errors.subject && (
                    <span className="text-xs text-red-400">
                      {translate("contact", "subjectError")}
                    </span>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  {touched.message && errors.message && (
                    <span className="text-xs text-red-400">
                      {translate("contact", "messageError")}
                    </span>
                  )}
                </div>
